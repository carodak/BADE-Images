...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/macbookpro/Documents/dossier_douglas/Katie/cognitive tasks/new/in progress/official/bade-images-pre/BADE-Images-Pre.py',
...
for thisPractice in practices:
    ...
    while continueRoutine:
        ...
        if image_1pr.status == STARTED:  # only update if drawing
            image_1pr.setOpacity((frameN)/300, log=False)
        ...
        if image_2pr.status == STARTED:  # only update if drawing
            image_2pr.setOpacity((frameN-frameNstart)/300, log=False)
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if image_1.status == STARTED:  # only update if drawing
            image_1.setOpacity((frameN)/300, log=False)
        ...
        if image_2.status == STARTED:  # only update if drawing
            image_2.setOpacity((frameN-frameNstart)/300, log=False)
